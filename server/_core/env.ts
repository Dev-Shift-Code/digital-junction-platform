...
export const ENV = {
  ...
  get gmailClientId() { return readEnv("GMAIL_CLIENT_ID"); },
  get gmailClientSecret() { return readEnv("GMAIL_CLIENT_SECRET"); },
  get gmailRefreshToken() { return readEnv("GMAIL_REFRESH_TOKEN"); },
  get gmailSenderEmail() { return readEnv("GMAIL_SENDER_EMAIL"); },
  get gmailReplyToEmail() { return readEnv("GMAIL_REPLY_TO"); },
