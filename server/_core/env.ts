...
export const ENV = {
  ...
  get resendApiKey() { return readEnv("RESEND_API_KEY"); },
  get resendFromEmail() { return readEnv("RESEND_FROM_EMAIL"); },
  get resendReplyToEmail() { return readEnv("RESEND_REPLY_TO"); },
