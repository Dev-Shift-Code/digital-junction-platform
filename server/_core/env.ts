...
export const ENV = {
  ...
  get appsScriptRelayUrl() { return readEnv("APPS_SCRIPT_RELAY_URL"); },
  get appsScriptRelaySecret() { return readEnv("APPS_SCRIPT_RELAY_SECRET"); },
  get appsScriptReplyToEmail() { return readEnv("APPS_SCRIPT_REPLY_TO"); },
