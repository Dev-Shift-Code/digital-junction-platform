  ...
  return (
    <PublicLayout>
      <main>
        ...
        <section className="bg-[#1A312C] py-16 text-[#FFF4E1] sm:py-20"><div className="site-container grid gap-8 md:grid-cols-[1fr_auto] md:items-center"><div><p className="font-mono text-[0.67rem] uppercase tracking-[0.13em] text-[#89D7B7]">A Digital Junction product library</p><h2 className="display mt-3 max-w-xl text-4xl leading-tight sm:text-5xl">Useful frameworks for the work between big launches.</h2></div><Link href="/shop" className="button-primary buttonlike !bg-[#89D7B7] !text-[#1A312C] hover:!bg-[#FFF4E1]">Explore products <ArrowRight className="size-4" /></Link></div></section>
