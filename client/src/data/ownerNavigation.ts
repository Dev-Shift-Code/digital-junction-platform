...
import { BadgePercent, Boxes, ChartNoAxesCombined, CircleHelp, CreditCard, FileText, FolderKanban, LayoutDashboard, Settings2, UsersRound } from "lucide-react";
...
export const ownerNavigation: DashboardNavigationItem[] = [
  ...
  { icon: CreditCard, label: "Payment Methods", path: "/owner/payment-methods" },
